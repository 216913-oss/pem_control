...
# 7. FEATURES
# =========================================================
features = ['V', 'I', 'T', 'err_lag1', 'err_lag2', 'err_lag5', 'err_lag30', 'err_ma10']
...
# =========================================================
# 10. MODEL (SWITCHED TO RANDOM FOREST)
# =========================================================
...
print("🌲 Training RANDOM FOREST LAG MODEL...")
...
h2_theo = I_theo = (I_test / 2 / 96500) * 24.4651 * 1000 * 60
...
print(f"🔥 RF MODEL R2: {r2:.4f}")
print(f"🔥 RF MODEL RMSE: {rmse:.4f}")
...
plt.plot(h2_pred[:200], '--', label='RF Model')
plt.legend()
plt.title("Random Forest Lag Model Prediction (t+1)")
plt.show()
...
try:
    ...
    if response.status_code == 200:
        print(f"✅ Metrics uploaded: R2={r2:.4f}, RMSE={rmse:.4f}")
    else:
